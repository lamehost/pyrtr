"""
Unit tests for the Serial Notify PDU module
"""
...
from pyrtr.rtr.pdu.serial_notify import LENGTH, TYPE, serialize, unserialize
...
class TestSerialize(unittest.TestCase):
    ...
    def test_max_values(self):
        """Test max values for session ID and serial"""
...
class TestUnserialize(unittest.TestCase):
    ...
    def test_unserialize_returns_typeddict(self):
        """Test that unserialize returns proper SerialNotify structure"""
